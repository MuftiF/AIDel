...
<title>TobaGuide - Pardalanan, Rute Cerdas AI</title>
...
<nav class="hidden lg:flex items-center gap-6">
    ...
    <div class="relative group">
        ...
        <div class="absolute top-full left-0 mt-6 w-48 bg-white border border-surface-dim rounded-xl overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 translate-y-2 group-hover:translate-y-0">
            ...
            <a href="{{ route('fitur.pardalanan') }}" class="block px-4 py-3 text-body-md text-primary bg-primary-container/40 font-semibold transition-colors border-t border-surface-dim">Pardalanan</a>
        </div>
    </div>
</nav>
...
<span class="material-symbols-outlined text-on-secondary-container" style="font-variation-settings: 'FILL' 1;">route</span>
</div>
<span class="text-label-md font-bold text-on-secondary-container uppercase tracking-wide">Fitur 03</span>
</div>
<h1 class="text-headline-lg font-headline-lg text-on-surface">Pardalanan</h1>
<p class="text-body-md text-on-surface-variant">
Berarti "perjalanan" — seluruh rute yang ditempuh, dari titik keberangkatan hingga tujuan akhir.
</p>
<p class="text-body-lg text-on-surface">
AI menyusun graf destinasi dan merekomendasikan urutan tempat yang paling optimal untuk dikunjungi, berdasarkan biaya transportasi, jarak, cuaca terkini, dan tingkat keramaian. Hasilnya bukan sekadar jalan pintas, tapi rangkaian perjalanan yang efisien dan berkesan.
</p>
<ul class="space-y-2 pt-2">
<li class="flex items-center gap-2 text-body-md text-on-surface-variant">
<span class="material-symbols-outlined text-primary text-lg">check_circle</span> Rekomendasi rute berbasis biaya & jarak transportasi
</li>
<li class="flex items-center gap-2 text-body-md text-on-surface-variant">
<span class="material-symbols-outlined text-primary text-lg">check_circle</span> Menyesuaikan otomatis dengan kondisi cuaca
</li>
<li class="flex items-center gap-2 text-body-md text-on-surface-variant">
<span class="material-symbols-outlined text-primary text-lg">check_circle</span> Menghindari destinasi yang sedang ramai
</li>
</ul>
...
<span class="material-symbols-outlined text-sm">route</span> Susun Rute Otomatis
</button>
</div>
<div class="order-1 lg:order-2 clay-card bg-white rounded-3xl p-6">
<div class="flex items-center justify-between mb-4">
<span class="text-label-md font-bold text-primary">Graf Rekomendasi</span>
<span class="text-label-md text-on-surface-variant flex items-center gap-1">
<span class="material-symbols-outlined text-sm">partly_cloudy_day</span> Cerah, 24°C
</span>
</div>
<div class="space-y-3">
<div class="flex items-center gap-3">
